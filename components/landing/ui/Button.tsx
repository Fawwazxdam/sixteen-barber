...
const buttonVariants = cva(
  "inline-flex items-center justify-center font-inter font-bold uppercase tracking-wide transition-all active:scale-95 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
