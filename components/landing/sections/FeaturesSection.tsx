...
const features = [
  {
    ...
    description:
      "Transaksi cepat, catat komisi otomatis, dan cetak struk digital langsung ke WhatsApp pelanggan.",
    icon: Calculator,
  },
  {
    title: "Reservasi Online",
    description:
      "Pelanggan bisa booking sendiri melalui link khusus, bebas antrean menumpuk dan pengaturan jadwal real-time.",
    icon: CalendarCheck,
  },
  {
    title: "Manajemen Kapster",
    description:
      "Atur jadwal shift, pantau performa tiap kapster, dan hitung bagi hasil secara presisi tanpa repot.",
    icon: Users,
  },
];
      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto text-lg dark:text-gray-400">
            Dirancang untuk kecepatan dan akurasi, memberikan kontrol penuh atas
            operasional toko Anda.
          </p>
        </div>
