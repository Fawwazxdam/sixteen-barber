...
export async function PricingSection() {
  ...
  const getButtonVariant = (isPopular: boolean) => (isPopular ? "default" : "outline");
  const getButtonText = (isPopular: boolean) => "Coba Gratis 14 Hari";
      ...
      <div className="max-w-7xl mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
          {plans.map((plan, index) => {
            const buttonVariant = getButtonVariant(plan.isPopular);
            const buttonText = getButtonText(plan.isPopular);
              ...
              >
                {plan.isPopular && (
                  <div
                    ...
                    text-[10px] font-black uppercase px-4 py-1 tracking-wide
                ...
                <Link href={`https://${appDomain}/register?plan=${plan.id}`} className="block w-full mt-auto">
                  <Button
